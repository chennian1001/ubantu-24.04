...
namespace lslidar_driver {
    ...
    class Input {
    public:
        Input(rclcpp::Node::SharedPtr private_nh, uint16_t port , int packet_size);
    ...
    public:
        InputSocket(rclcpp::Node::SharedPtr private_nh, uint16_t port = MSOP_DATA_PORT_NUMBER, int packet_size = 1212);
